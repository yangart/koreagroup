...
//        document.getElementById("navbar-nav").setAttribute("data-simplebar", ""),
    ...
    function m() {
        ...
        y("vertical"),
        s()),
        "horizontal" != sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"),
        document.querySelector(".hamburger-icon")) && document.querySelector(".hamburger-icon").classList.add("open"),
        document.querySelectorAll("#navbarNav > li.nav-item"));
        Array.from(e).forEach(function(e) {
    ...
    function O() {
        ...
        0 < e && document.querySelector(".hamburger-icon").classList.toggle("open"),
        ...
        "vertical" === document.documentElement.getAttribute("data-layout") && (e <= 1025 && 0 < e ? (document.body.classList.remove("vertical-sidebar-enable"),
        "sm" == document.documentElement.getAttribute("data-sidebar-size") ? document.documentElement.setAttribute("data-sidebar-size", "lg") : document.documentElement.setAttribute("data-sidebar-size", "sm")) : 1025 < e ? (document.body.classList.remove("vertical-sidebar-enable"),
        ...
        "semibox" === document.documentElement.getAttribute("data-layout") && (0 < e ? "show" == document.documentElement.getAttribute("data-sidebar-visibility") ? "lg" == document.documentElement.getAttribute("data-sidebar-size") ? document.documentElement.setAttribute("data-sidebar-size", "sm") : document.documentElement.setAttribute("data-sidebar-size", "lg") : (document.getElementById("sidebar-visibility-show").click(),
...
//        document.getElementById("navbar-nav").removeAttribute("data-simplebar"),
    ...
    function e(e) {
        if (e == e) {
            ...
            default:
                ...
                T("data-body-image", "img-3"),
                document.documentElement.setAttribute("data-body-image", "img-3")) : "none" == sessionStorage.getItem("data-body-image") && (sessionStorage.setItem("data-body-image", "none"),
                T("data-body-image", "none"),
                document.documentElement.setAttribute("data-body-image", "none"))
            }
        }
    ...
    sessionStorage.getItem("defaultAttribute") ? ((f = {})["data-layout"] = sessionStorage.getItem("data-layout"),
    ...
    e(f)) : (L = document.documentElement.attributes,
    f = {},
    ...
    (I = document.getElementById("search-options")) && (I.addEventListener("focus", function() {
        ...
        h.classList.remove("d-none")) : (v.classList.remove("show"),
    ...
    (z = document.querySelectorAll(".light-dark-mode")) && z.length && z[0].addEventListener("click", function(e) {
        B.hasAttribute("data-bs-theme") && "dark" == B.getAttribute("data-bs-theme") ? C("data-bs-theme", "light", "layout-mode-light", B) : C("data-bs-theme", "dark", "layout-mode-dark", B),
        window.dispatchEvent(x)
    }),
    G(),
    D(),
    r(),
    document.getElementsByClassName("dropdown-item-cart") && (k = document.querySelectorAll(".dropdown-item-cart").length,
...
//    44 < document.body.scrollTop || 44 < document.documentElement.scrollTop ? mybutton.classList.add("active") : mybutton.classList.remove("active")
